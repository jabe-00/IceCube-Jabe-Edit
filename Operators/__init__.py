...
classes = (
    ...
    bring_world_bone.ICECUBE_OT_BringWorldBone,
    bring_world_bone.ICECUBE_OT_CopyTransform,
    bring_world_bone.ICECUBE_OT_PasteTransform
)
