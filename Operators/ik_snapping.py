...
class ICECUBE_Convert_FK_TO_IK_ARM_L(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        rig = context.object
        rig.minecraft_accurate_scaling = False
        ...
        def minecraft_scale():
            ...
            if hasattr(rig, "minecraft_scale"):
                rig.minecraft_scale()  
            ...
            rig.minecraft_accurate_scaling = True

            bpy.context.view_layer.update()
            bpy.context.evaluated_depsgraph_get().update()
            rig.update_tag()

        bpy.app.timers.register(minecraft_scale, first_interval=0.1)
